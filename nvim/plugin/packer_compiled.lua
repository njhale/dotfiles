...
_G.packer_plugins = {
  ...
  ["colorbuddy.vim"] = {
    loaded = true,
    path = "/Users/njhale/.local/share/nvim/site/pack/packer/start/colorbuddy.vim",
  ...
  ["monokai-soda.vim"] = {
    loaded = true,
    path = "/Users/njhale/.local/share/nvim/site/pack/packer/start/monokai-soda.vim",
  ...
  ["packer.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/njhale/.local/share/nvim/site/pack/packer/opt/packer.nvim",
  ...
  ["vim-easy-align"] = {
    loaded = true,
    path = "/Users/njhale/.local/share/nvim/site/pack/packer/start/vim-easy-align",
